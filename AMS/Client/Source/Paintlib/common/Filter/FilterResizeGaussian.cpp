...
CFilterResizeGaussian::CFilterResizeGaussian (int NewXSize, int NewYSize, double NewRadius)
  : CFilterResize (NewXSize, NewYSize),
    m_NewRadius(NewRadius)
{
}

void CFilterResizeGaussian::Apply(CBmp * pBmpSource, CBmp * pBmpDest)
{
  ...
  C2PassScale <CGaussianFilter, CDataPaintLib32> sS(m_NewRadius);
...
/--------------------------------------------------------------------
|
|      $Log: FilterResizeGaussian.cpp,v $
