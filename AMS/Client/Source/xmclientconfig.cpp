...
bool CXMClientConfig::New()
{
	...
	SetField(FIELD_GUI_MAIN_WND_X, "50");
	SetField(FIELD_GUI_MAIN_WND_Y, "50");
	SetField(FIELD_GUI_MAIN_WND_CX, "500");
	SetField(FIELD_GUI_MAIN_WND_CY, "350");
	SetField(FIELD_GUI_MAIN_WND_MODE, "0");
