...
namespace msn2.net.Pictures
{
	...
	public partial class PicDataClassesDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteRecentCategory(RecentCategory instance);
		...
		static PicDataClassesDataContext()
		{
		}
		
		public PicDataClassesDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PicDataClassesDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PicDataClassesDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PicDataClassesDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public PicDataClassesDataContext() : 
				base(global::msn2.net.Pictures.Properties.Settings.Default.picdbConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnPictureIdChanged();
		...
		private void attach_PictureCategories(PictureCategory entity)
		{
			...
			this.SendPropertyChanged("PictureCategories");
		}
    ...
    partial void OnGroupNameChanged();
		...
		private void attach_PersonGroups(PersonGroup entity)
		{
			this.SendPropertyChanging();
			entity.Group = this;
			this.SendPropertyChanged("PersonGroups");
		}
    ...
    partial void OnWindowsUserNameChanged();
		...
		private void attach_PictureComments(PictureComment entity)
		{
			this.SendPropertyChanging();
			entity.Person = this;
			this.SendPropertyChanged("PictureComments");
		}
		...
		private void attach_PicturePersons(PicturePerson entity)
		{
			this.SendPropertyChanging();
			entity.Person = this;
			this.SendPropertyChanged("PicturePersons");
		}
		...
		private void attach_PictureRatings(PictureRating entity)
		{
			this.SendPropertyChanging();
			entity.Person = this;
			this.SendPropertyChanged("PictureRatings");
		}
    ...
    partial void OnAverageRatingChanged();
		...
		private void attach_PictureCaches(PictureCache entity)
		{
			this.SendPropertyChanging();
			entity.Picture = this;
			this.SendPropertyChanged("PictureCaches");
		}
