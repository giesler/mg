...
namespace msn2.net.Pictures
{
	...
	public class ImageUtilities
	{
		...
		public ImageUtilities(string connectionString, string pictureLocation, string pictureCacheLocation)
		{
			this.pictureLocation		= pictureLocation;
			this.pictureCacheLocation	= pictureCacheLocation;
		...
		private void CreateUpdateCachedImage(ref DataSetPicture dsPicture, DataSetPicture.PictureRow pictureRow,
			...
			string sourceFile = pictureLocation + pictureRow.Filename;
			string targetFile = pictureCacheLocation + cacheRow.Filename;
