VERSION 5.00
Begin VB.Form dlgWiz26 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "SQL App Setup Wizard (Step 26)"
   ClientHeight    =   3195
   ClientLeft      =   2760
   ClientTop       =   3750
   ClientWidth     =   6030
   ...
   Begin VB.Label Label2 
      Caption         =   "Install Microsoft Access 2000 Database"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "dlgWiz26"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
 ' Step 26: Install MS Access 2000 Runtime
Option Explicit
...
strCommand = App.Path & "\accessrt\setup.exe /wait /q"
RunProgramAndWait strCommand, 5
...
Private Sub Form_Load()
    ...
    mstrDetails = _
        "Setup needs to install Microsoft Access 2000 Runtime. " & vbCrLf & vbCrLf & _
