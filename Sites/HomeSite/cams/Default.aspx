...
<body>
    ...
    <asp:Panel runat="server" ID="topLinks" CssClass="linkPanel">
        ...
        <asp:HyperLink runat="server" ID="logLink1" NavigateUrl="https://nas.giesler.org:58433/webman/3rdparty/SurveillanceStation/" Text="log" Visible="false" /> 
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="bottomLinks" CssClass="linkPanel" Visible="false">
        ...
        <asp:HyperLink runat="server" ID="logLink2" NavigateUrl="https://nas.giesler.org:58433/webman/3rdparty/SurveillanceStation/" Text="log" Visible="false" /> 
    </asp:Panel>
