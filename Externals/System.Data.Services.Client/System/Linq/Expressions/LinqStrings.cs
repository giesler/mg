namespace System.Linq.Expressions
{
    ...
    internal static class LinqStrings
    {
        internal static string AmbiguousJump(object p0)
        {
            return SR.GetString("AmbiguousJump", new object[] { p0 });
        }

        internal static string AmbiguousMatchInExpandoObject(object p0)
        {
            return SR.GetString("AmbiguousMatchInExpandoObject", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("BinderNotCompatibleWithCallSite", new object[] { p0, p1, p2 });
        }
        ...
        {
            return SR.GetString("CannotCloseOverByRef", new object[] { p0, p1 });
        }

        internal static string CannotCompileConstant(object p0)
        {
            return SR.GetString("CannotCompileConstant", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("DuplicateVariable", new object[] { p0 });
        }

        internal static string DynamicBinderResultNotAssignable(object p0, object p1, object p2)
        {
            return SR.GetString("DynamicBinderResultNotAssignable", new object[] { p0, p1, p2 });
        }

        internal static string DynamicBindingNeedsRestrictions(object p0, object p1)
        {
            return SR.GetString("DynamicBindingNeedsRestrictions", new object[] { p0, p1 });
        }

        internal static string DynamicObjectResultNotAssignable(object p0, object p1, object p2, object p3)
        {
            return SR.GetString("DynamicObjectResultNotAssignable", new object[] { p0, p1, p2, p3 });
        }
        ...
        {
            return SR.GetString("EqualityMustReturnBoolean", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("ExpressionTypeDoesNotMatchAssignment", new object[] { p0, p1 });
        }
        ...
        {
            return SR.GetString("ExpressionTypeDoesNotMatchLabel", new object[] { p0, p1 });
        }
        ...
        {
            return SR.GetString("ExtensionNodeMustOverrideProperty", new object[] { p0 });
        }

        internal static string FieldInfoNotDefinedForType(object p0, object p1, object p2)
        {
            return SR.GetString("FieldInfoNotDefinedForType", new object[] { p0, p1, p2 });
        }
        ...
        {
            return SR.GetString("GenericMethodWithArgsDoesNotExistOnType", new object[] { p0, p1 });
        }

        internal static string IllegalNewGenericParams(object p0)
        {
            return SR.GetString("IllegalNewGenericParams", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("InstanceAndMethodTypeMismatch", new object[] { p0, p1, p2 });
        }

        internal static string InstanceFieldNotDefinedForType(object p0, object p1)
        {
            return SR.GetString("InstanceFieldNotDefinedForType", new object[] { p0, p1 });
        }

        internal static string InstancePropertyNotDefinedForType(object p0, object p1)
        {
            return SR.GetString("InstancePropertyNotDefinedForType", new object[] { p0, p1 });
        }

        internal static string InstancePropertyWithoutParameterNotDefinedForType(object p0, object p1)
        {
            return SR.GetString("InstancePropertyWithoutParameterNotDefinedForType", new object[] { p0, p1 });
        }

        internal static string InstancePropertyWithSpecifiedParametersNotDefinedForType(object p0, object p1, object p2)
        {
            return SR.GetString("InstancePropertyWithSpecifiedParametersNotDefinedForType", new object[] { p0, p1, p2 });
        }
        ...
        {
            return SR.GetString("InvalidLvalue", new object[] { p0 });
        }

        internal static string InvalidMemberType(object p0)
        {
            return SR.GetString("InvalidMemberType", new object[] { p0 });
        }

        internal static string InvalidMetaObjectCreated(object p0)
        {
            return SR.GetString("InvalidMetaObjectCreated", new object[] { p0 });
        }

        internal static string InvalidNullValue(object p0)
        {
            return SR.GetString("InvalidNullValue", new object[] { p0 });
        }

        internal static string InvalidObjectType(object p0, object p1)
        {
            return SR.GetString("InvalidObjectType", new object[] { p0, p1 });
        }

        internal static string InvalidOperation(object p0)
        {
            return SR.GetString("InvalidOperation", new object[] { p0 });
        }

        internal static string KeyDoesNotExistInExpando(object p0)
        {
            return SR.GetString("KeyDoesNotExistInExpando", new object[] { p0 });
        }

        internal static string LabelTargetAlreadyDefined(object p0)
        {
            return SR.GetString("LabelTargetAlreadyDefined", new object[] { p0 });
        }

        internal static string LabelTargetUndefined(object p0)
        {
            return SR.GetString("LabelTargetUndefined", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("MustRewriteChildToSameType", new object[] { p0, p1, p2 });
        }

        internal static string MustRewriteToSameNode(object p0, object p1, object p2)
        {
            return SR.GetString("MustRewriteToSameNode", new object[] { p0, p1, p2 });
        }

        internal static string MustRewriteWithoutMethod(object p0, object p1)
        {
            return SR.GetString("MustRewriteWithoutMethod", new object[] { p0, p1 });
        }

        internal static string NonLocalJumpWithValue(object p0)
        {
            return SR.GetString("NonLocalJumpWithValue", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("OutOfRange", new object[] { p0, p1 });
        }

        internal static string OverloadOperatorTypeDoesNotMatchConversionType(object p0, object p1)
        {
            return SR.GetString("OverloadOperatorTypeDoesNotMatchConversionType", new object[] { p0, p1 });
        }
        ...
        {
            return SR.GetString("PropertyDoesNotHaveAccessor", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("PropertyWithMoreThanOneMatch", new object[] { p0, p1 });
        }

        internal static string ReferenceEqualityNotDefined(object p0, object p1)
        {
            return SR.GetString("ReferenceEqualityNotDefined", new object[] { p0, p1 });
        }

        internal static string SameKeyExistsInExpando(object p0)
        {
            return SR.GetString("SameKeyExistsInExpando", new object[] { p0 });
        }

        internal static string SwitchValueTypeDoesNotMatchComparisonMethodParameter(object p0, object p1)
        {
            return SR.GetString("SwitchValueTypeDoesNotMatchComparisonMethodParameter", new object[] { p0, p1 });
        }

        internal static string TestValueTypeDoesNotMatchComparisonMethodParameter(object p0, object p1)
        {
            return SR.GetString("TestValueTypeDoesNotMatchComparisonMethodParameter", new object[] { p0, p1 });
        }

        internal static string TryNotSupportedForMethodsWithRefArgs(object p0)
        {
            return SR.GetString("TryNotSupportedForMethodsWithRefArgs", new object[] { p0 });
        }

        internal static string TryNotSupportedForValueTypeInstances(object p0)
        {
            return SR.GetString("TryNotSupportedForValueTypeInstances", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("UndefinedVariable", new object[] { p0, p1, p2 });
        }

        internal static string UnexpectedVarArgsCall(object p0)
        {
            return SR.GetString("UnexpectedVarArgsCall", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("UnknownLiftType", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("UserDefinedOpMustHaveConsistentTypes", new object[] { p0, p1 });
        }

        internal static string UserDefinedOpMustHaveValidReturnType(object p0, object p1)
        {
            return SR.GetString("UserDefinedOpMustHaveValidReturnType", new object[] { p0, p1 });
        }

        internal static string VariableMustNotBeByRef(object p0, object p1)
        {
            return SR.GetString("VariableMustNotBeByRef", new object[] { p0, p1 });
        }
