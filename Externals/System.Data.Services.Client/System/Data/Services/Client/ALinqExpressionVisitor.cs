namespace System.Data.Services.Client
{
    ...
    internal abstract class ALinqExpressionVisitor
    {
        ...
        internal virtual Expression VisitLambda(LambdaExpression lambda)
        {
            ...
            if (body != lambda.Body)
            {
                ParameterExpression[] array = new ParameterExpression[lambda.Parameters.Count];
                lambda.Parameters.CopyTo(array, 0);
                return ExpressionHelpers.CreateLambda(lambda.Type, body, array);
            }
            return lambda;
        }
