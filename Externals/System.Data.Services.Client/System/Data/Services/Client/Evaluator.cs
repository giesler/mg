    ...
    internal static class Evaluator
    {
        ...
        internal class Nominator : DataServiceALinqExpressionVisitor
        {
            ...
            internal override Expression Visit(Expression expression)
            {
                if (expression != null)
                {
                    ...
                    {
                        if (this.functionCanBeEvaluated.Invoke(expression))
                        {
        ...
        internal class SubtreeEvaluator : DataServiceALinqExpressionVisitor
        {
            ...
            private static Expression Evaluate(Expression e)
            {
                ...
                object obj2 = ExpressionEvaluator.CreateDelegate(ExpressionHelpers.CreateLambda(e, new ParameterExpression[0])).DynamicInvoke(null);
                Debug.Assert(!(obj2 is Expression), "!(constantValue is Expression)");
                Type type = e.Type;
