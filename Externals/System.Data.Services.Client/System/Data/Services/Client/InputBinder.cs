namespace System.Data.Services.Client
{
    ...
    internal sealed class InputBinder : DataServiceALinqExpressionVisitor
    {
        ...
        internal override Expression VisitMemberAccess(MemberExpression m)
        {
            ...
            for (MemberExpression expression2 = m; ((expression2 != null) && (expression2.Member.MemberType == MemberTypes.Property)) && (expression2.Expression != null); expression2 = expression2.Expression as MemberExpression)
            {
            ...
            while (stack.Count > 0)
            {
                ...
                else
                {
                    ...
                    flag = true;
                    stack.Pop();
                    Debug.Assert(expression5 != null, "source != null -- otherwise ResourceBinder created an accessor to nowhere");
