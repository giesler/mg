...
namespace msn2.net.ShoppingList
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="ListGo")]
    ...
    partial void DeleteList(List instance);
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.GetTopCommonListItems")]
		public ISingleResult<GetTopCommonListItemsResult> GetTopCommonListItems([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="UniqueIdentifier")] System.Nullable<System.Guid> listUniqueId, [global::System.Data.Linq.Mapping.ParameterAttribute(DbType="Int")] System.Nullable<int> topCount)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), listUniqueId, topCount);
			return ((ISingleResult<GetTopCommonListItemsResult>)(result.ReturnValue));
		}
	}
	...
	[global::System.Runtime.Serialization.DataContractAttribute()]
	public partial class GetTopCommonListItemsResult
	{
		
		private string _Name;
		
		public GetTopCommonListItemsResult()
		{
		}
