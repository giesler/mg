...
<html>
	<head>
		<title>Adult Media Swapper - Indexing Contest</title>
	...
	<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" link="#E22000" vlink="#bf0400" alink="#ef1c19">
		...
		<p>
			...
			In a nutshell: AMS is a peer-to-peer adult media sharing application with 
			thumbnail displays and advanced searching capabilities. With AMS you can 
			quickly find adult media that fits your interests and share your personal 
			collections with the rest of the world.
		</p>
		<br>
		<h4>
			Entering is simple:
		...
		<table border="0">
			...
			<tr>
				<td width="483">
					<p>
						<i>From this graph you can see that minimally indexing many pictures is not nearly 
							as effective as completely indexing fewer pictures.</i>
					</p>
				</td>
			</tr>
		</table>
		<p>
			The scoring formula is: X=Y^(1.2+.01*Y) where Y is the number of unique fields 
			indexed (22 maximum.) Categories are calculated separately and added to the 
			fields score above. Categories are simply: 10 points for the first category, 5 
			for the second category, and one point for each category there after. Note that 
			in the above graph the points for category indexes are not shown.
		</p>
		<br>
		<h4>
			Disclaimers:
		...
		<ul>
			<li>
				AMS does not guaranty these prizes, nor will we replace a damaged prize. That 
				is between you and the manufacture (prizes are brand new, with full 
				manufacture’s warranty.) AMS will not be held responsible for any damage these 
