...
garrLayoutParts[7] = new objPart("MSUPS", "collapsed")
garrLayoutParts[8] = new objPart("UPSTrack", "collapsed")
garrLayoutParts[9] = new objPart("AskJeeves", "collapsed")
...
</font><!--mstheme--></font><table border="0" cellpadding="5" cellspacing="0">
  <tr>
		<td rowSpan="5" valign="top"><!--mstheme--><font face="Arial, Helvetica"></font><!--mstheme--></font><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="200" align="center" valign="top"><!--mstheme--><font face="Arial, Helvetica">
					
					</font><!--mstheme--></font><table cellpadding="0" cellspacing="3" border="0">
					<tr><td><!--mstheme--><font face="Arial, Helvetica">
						</font><!--mstheme--></font><table width="200" cellpadding="0" cellspacing="0" bgColor="#000000"><tr><td><!--mstheme--><font face="Arial, Helvetica">
							</font><!--mstheme--></font><table cellpadding="0" cellspacing="0">
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<font face="Arial" size="2" color="#FFFFFF">Google</font>
								...
								<input type="hidden" name="cof" VALUE="GIMP:#FFFF40;T:#FFFFFF;BIMG:http://mike.giesler.org/_themes/mikes-website/blackbg.gif;ALC:#FFCC99;GFNT:#FFFFC0;LC:#FFFF00;BGC:#000000;AH:center;VLC:#FFFF99;GL:2;GALT:#C0FFFF;AWFID:48f9c49ef451ce28;">
									...
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input TYPE="text" name="q" size="31" maxlength="255" value style="font-family: Arial; font-size: 8pt" id="GoogleFocus">
						...
						</font><!--mstheme--></font></td></tr><tr><td><!--mstheme--><font face="Arial, Helvetica">

						</font><!--mstheme--></font><table width="200" cellpadding="0" cellspacing="0" bgColor="#000000"><tr><td><!--mstheme--><font face="Arial, Helvetica">
							</font><!--mstheme--></font><table cellpadding="0" cellspacing="0">
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<a href="http://www.av.com"><img src="av_logo.gif" border="0"></a>
									</font><!--mstheme--></font></td>
									<td align="right" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
							...
							<span id="AltaVistaContent" style="display: none">
			   				<form action="http://altavista.digital.com/cgi-bin/query" method="GET" name="frmAltaVista" id="frmAltaVista">
								...
								</font><!--mstheme--></font><table cellpadding="0" cellspacing="0" width="100%" align="center">
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" size="15" maxlength="200" name="q" style="font-family: Arial; font-size: 8pt" id="AltaVistaFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							...
							<span id="YahooContent" style="display: none">
								<form action="http://search.yahoo.com/bin/search" method="GET" name="frmYahoo" id="frmYahoo">
									...
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" size="15" name="p" style="font-family: Arial; font-size: 8pt" id="YahooFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							...
							<span id="LycosContent" style="display: none">
								<form action="http://www.lycos.com/cgi-bin/pursuit" method="GET" name="frmLycos" id="frmLycos">
									...
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" size="15" name="query" style="font-family: Arial; font-size: 8pt" id="LycosFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							...
							<span id="ExciteContent" style="display: none">
							  ...
							  <input type="hidden" name="trace" value="a">
									...
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" size="15" name="search" style="font-family: Arial; font-size: 8pt" id="ExciteFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							  ...
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<font face="Arial" size="2" color="#FFFFFF">Redmond Yellow Pages</font>
									</font><!--mstheme--></font></td>
									<td align="right" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
							...
							<span id="YellowPagesContent" style="display: none">
								...
								<input TYPE="HIDDEN" NAME="BizBasicSearchForm"> 
								<input NAME="RSC" TYPE="HIDDEN" VALUE="2"> 
								<input NAME="HUSERFU" TYPE="HIDDEN" VALUE="0"> 
								<input NAME="KWDT" TYPE="HIDDEN" VALUE="4"> 
								<input NAME="HCKWD" TYPE="HIDDEN" VALUE> 
								<input type="hidden" name="UIS" value="72">
								<input NAME="CSZ" TYPE="HIDDEN" VALUE="REDMOND" SIZE="15" MAXLENGTH="255" VALUE>
								<input NAME="STATE" TYPE="HIDDEN" VALUE="WA">
								</font><!--mstheme--></font><table cellpadding="0" cellspacing="0" width="100%" align="center">
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" size="15" name="KWD" style="font-family: Arial; font-size: 8pt" id="YellowPagesFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">

<!--								<form method="get" action="http://yp.yahoo.com/py/ypBrowse.py?" name="frmYellowPages" id="frmYellowPages">								<input type="hidden" name="city" value="Redmond"><input type="hidden" name="state" value="WA">								<input type="hidden" name="zip" value="98052"><input type="hidden" name="stp" value="a">								</font><table cellpadding="0" cellspacing="0" width="100%" align="center">									<tr>										<td width="100%" align="center" height="20" bgcolor="#000000">											<input type="text" name="stx" size="15" maxlength="65" style="font-family: Arial; font-size: 8pt" id="YellowPagesFocus">										</font></td>								  </tr>								</table>-->
							  ...
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<font face="Arial" size="2" color="#FFFFFF">Dictionary</font>
									</font><!--mstheme--></font></td>
									<td align="right" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
							...
							<span id="DictionaryContent" style="display: none">
								...
								<input type="hidden" name="book" value="Dictionary">
									...
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" name="va" size="15" style="font-family: Arial; font-size: 8pt" id="DictionaryFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							  ...
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
											<font face="Arial" size="2" color="#FFFFFF">MS Beta Shipments</font>
									</font><!--mstheme--></font></td>
									<td align="right" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<img src="expand.gif" id="MSUPSImage" onclick="ShowHide('MSUPS')" WIDTH="9" HEIGHT="9"><img src="trans.gif" width="4">
									</font><!--mstheme--></font></td>
								</tr>
							</table><!--mstheme--><font face="Arial, Helvetica">
							<span id="MSUPSContent" style="display: none">
								<form method="GET" action="http://wwwapps.ups.com/etracking/tracking.cgi" id="frmUPSShipments">
								<input TYPE="HIDDEN" NAME="TypeOfInquiryNumber" VALUE="R">
								<input TYPE="HIDDEN" NAME="HTMLVersion" VALUE="4.0">
								<input TYPE="HIDDEN" NAME="InquiryNumber" VALUE="ronlan">
								<script language="JavaScript"><!--
								var time = new Date();		// figure out date one month ago, month is zero based
								var offset = 0;
								var yOffset = 0;
								if (time.getMonth() == 0) {
								  offset = 12;
								...
								document.write("<INPUT TYPE=HIDDEN NAME=FromPickupMonth VALUE=" + (time.getMonth()+offset) + ">"); 
								document.write("<INPUT TYPE=HIDDEN NAME=FromPickupDay VALUE=" + (time.getDate()) + ">");
								document.write("<INPUT TYPE=HIDDEN NAME=FromPickupYear VALUE=" + (time.getYear()+yOffset) + ">");

								document.write("<INPUT TYPE=HIDDEN NAME=ToPickupMonth VALUE=" + (time.getMonth()+1) + ">"); 
								document.write("<INPUT TYPE=HIDDEN NAME=ToPickupDay VALUE=" + (time.getDate()) + ">");
								document.write("<INPUT TYPE=HIDDEN NAME=ToPickupYear VALUE=" + (time.getYear()) + ">");
								// -->
								</script>
								<input type="hidden" name="SenderShipperNumber" value>
								<input type="hidden" name="DestinationCountry" value="US">
								</font><!--mstheme--></font><table cellpadding="0" cellspacing="0" width="100%" align="center">
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input type="text" size="5" name="DestinationPostalCode" value="53714" style="font-size: 8pt; font-family: Arial" id="MSUPSFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							  ...
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<font face="Arial" size="2" color="#FFFFFF">UPS Tracking Number</font>
									</font><!--mstheme--></font></td>
									<td align="right" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<img src="expand.gif" id="UPSTrackImage" onclick="ShowHide('UPSTrack')" WIDTH="9" HEIGHT="9"><img src="trans.gif" width="4">
									</font><!--mstheme--></font></td>
								</tr>
							</table><!--mstheme--><font face="Arial, Helvetica">
							<span id="UPSTrackContent" style="display: none">
								<form method="GET" action="http://wwwapps.ups.com/etracking/tracking.cgi" id="frmUPSTrack">
							  <input TYPE="HIDDEN" NAME="tracknums_displayed" VALUE="1">
								...
								<input TYPE="HIDDEN" NAME="sort_by" VALUE="status">
									...
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input NAME="InquiryNumber1" SIZE="24" MAXLENGTH="24" style="font-size: 8pt; font-family: Arial" id="UPSTrackFocus">
										</font><!--mstheme--></font></td>
								  </tr>
								</table><!--mstheme--><font face="Arial, Helvetica">
								</form>
							  ...
							  <tr>
							    <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
										<font size="2" face="Arial">Ask Jeeves</font></a>
									</font><!--mstheme--></font></td>
									<td align="right" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
							...
							<span id="AskJeevesContent" style="display: none">
								...
								<input NAME="origin" TYPE="hidden" VALUE="0">
								<input NAME="site_name" TYPE="hidden" VALUE="Jeeves">
								<input NAME="metasearch" TYPE="hidden" VALUE="yes">
								</font><!--mstheme--></font><table cellpadding="0" cellspacing="0" width="100%" align="center">
									<tr>
										<td width="100%" align="center" height="20" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
											<input NAME="ask" SIZE="20" MAXSIZE="255" style="font-size: 8pt; font-family: Arial" id="AskJeevesFocus">
			...
			</table><!--mstheme--><font face="Arial, Helvetica"></font><!--mstheme--></font></td>
  
    <td valign="top" colSpan="2"><!--mstheme--><font face="Arial, Helvetica">


      </font><!--mstheme--></font><table border="0" width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica">
							<font face="Arial" size="2" color="#FFFFFF"><!-- | 
							<a href="#" onclick="WeatherMain('SEA')">Seattle</a> |
							<a href="#" onclick="WeatherMain('MKE')">Milwaukee</a>-->
					<a href="#" onClick="WeatherMain('WAKI')">Kirkland</a> | 
					<a href="#" onclick="WeatherMain('MSN')">Madison</a>
					 Weather</font></font><!--mstheme--></font></td>
          </tr>
					<tr>
...
<div id="msnbcWeaWPQ2">
	...
	<!--mstheme--></font><table border=0>
		<tr>
			<td><!--mstheme--><font face="Arial, Helvetica"><img src="clogo.gif" height="30"><!--mstheme--></font></td>
			<td><!--mstheme--><font face="Arial, Helvetica">&nbsp;<!--mstheme--></font></td>
			<td><!--mstheme--><font face="Arial, Helvetica"><font size=-1>Loading...</font><!--mstheme--></font></td>
			<td><!--mstheme--><font face="Arial, Helvetica"><img src="trans.gif" height="37" width="1"><!--mstheme--></font></td>
		</tr>
	</table><!--mstheme--><font face="Arial, Helvetica">
	<br><br>
</div>
...
function RenderWeather(oWea) {
	...
	if (bFore) {aFore = oWea.swFore.split("|");}
		sTmp += '<table cellpadding=0 cellspacing=3 border=0>';
			sTmp += '<tr>';
				...
				if (oWea.swCity == 'Seattle') {
					...
					sTmp += '<font color="#00FF00"><a href="http://www.intellicast.com/LocalWeather/World/UnitedStates/Northwest/Washington/Seattle/RadarLoop/">Radar</a></font></font></font>';
...
//			sTmp += '<tr><td colSpan=5 align=center style=font-size:60%;><i>Last updated '+oWea.swLastUp+'</td></tr>';
		sTmp += '</table>';
	return sTmp;
}
</script>
...
<script id="msnbcWeaMainWPQ2" language="javascript"><%=WeatherFunctions()%></script>
      ...
      <!--mstheme--></font><table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2" color="#FFFFFF">Microsoft</font></font><!--mstheme--></font></td>
        </tr>
        <tr>
          <td width="100%" align="center" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2"><a href="http://www.microsoft.com/ms.htm">Home</a>
				    | <a href="http://search.support.microsoft.com/kb/c.asp?SA=PER&amp;LNG=ENG">Support</a>&nbsp;<a href="http://msdn.microsoft.com/default.asp"><br>
            MSDN</a>:
            <a href="http://premium.microsoft.com/msdn/library/">Lib</a>
            | <a href="http://search.microsoft.com/us/dev/default.asp">Search</a>
            | <a href="http://msdn.microsoft.com/bugs/">Bugs</a>
            <br><a href="http://www.betaplace.com">BetaPlace</a></font> <font face="Arial" size="2">|
            <a href="http://beta.windowsupdate.com">WU</a> | <a href="http://windowsbeta.microsoft.com/Default.asp">XP</a> | <a href="http://beta.visualstudio.net">VS</a><br>
            <a href="http://www.microsoft.com/windows2000">Win2k</a> | <a href="http://www.microsoft.com/technet">TechNet</a> | <a href="http://www.microsoft.com/commerceserver">Commerce</a><br>
    ...
    <td valign="top" align="center"><!--mstheme--><font face="Arial, Helvetica">
        ...
        <tr>
          <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2" color="#FFFFFF">News</font></font><!--mstheme--></font></td>
        </tr>
        <tr>
          <td width="100%" align="center" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
						<font size="2" face="Arial"><a href="http://abcnews.go.com/">ABC</a> | <a href="http://www.cnn.com">CNN</a> |
						<a href="http://www.theonion.com">Onion</a><br>
						<a href="http://www.usatoday.com">USA Today</a> | <a href="http://www.msnbc.com">MSNBC</a><br>
						<a href="http://slashdot.org">SlashDot</a> | <a href="http://www.activewin.com">ActiveWin</a><br>
			      <a href="http://news.com">news.com</a> | <a href="http://www.15seconds.com">15secs</a><br>
			      <a href="http://seattletimes.nwsource.com/cgi-bin/WebObjects/SeattleTimes.woa/wa/">Seattle Times</a> | <a href="http://seattle.citysearch.com/">CitySearch</a></font>
			    </font><!--mstheme--></font></td>
        </tr>
      </table><!--mstheme--><font face="Arial, Helvetica">
    </font><!--mstheme--></font></td>
  ...
  <tr>
    <td valign="middle" align="center"><!--mstheme--><font face="Arial, Helvetica">
      <!--mstheme--></font><table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2" color="#FFFFFF">Other
            Sites</font></font><!--mstheme--></font></td>
        </tr>
        <tr>
          <td width="100%" align="center" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
						<font face="Arial"><small>Y!: <a href="http://my.yahoo.com">My</a> | <a href="http://local.yahoo.com">Local</a> | <a href="http://maps.yahoo.com">Maps</a>
						| <a href="http://mail.yahoo.com">Mail</a><br>
						<a href="http://cws.internet.com/new.html">New Apps</a><br>
						<br><a href="http://mail.giesler.org">mail.giesler.org</a> | <a href="https://mail.microsoft.com/exchange">mail.ms.com</a></small></font>
					<!--mstheme--></font></td>
        </tr>
      </table><!--mstheme--><font face="Arial, Helvetica">
		<!--mstheme--></font></td>
    ...
    <td align="center" valign="middle" align="center"><!--mstheme--><font face="Arial, Helvetica">
        ...
        <tr>
          <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2" color="#FFFFFF">TV</font></font><!--mstheme--></font></td>
        </tr>
        <tr>
          <td width="100%" align="center" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
						<font size="2" face="Arial">
						<a href="http://msn.gist.com/tv/grid.jsp?page=1">TV Listings</a><br>
						<a href="http://espn.go.com">ESPN</a>  | <a href="http://www.foxsports.com">FoxSports</a><br>
						<a href="http://www.fox.com">Fox</a>  | <a href="http://www.nbc.com">NBC</a>  | <a href="http://www.abc.com">ABC</a> | <a href="http://www.cbs.com">CBS</a><br>
            <a href="http://www.comedycentral.com">CC</a>  | <a href="http://www.mtv.com">MTV</a> | <a href="http://www.discovery.com">Discovery</a>
            </font>
          </font><!--mstheme--></font></td>
        </tr>
      </table><!--mstheme--><font face="Arial, Helvetica">
      ...
      <!--mstheme--></font><table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2" color="#FFFFFF">UW</font></font><!--mstheme--></font></td>
        </tr>
        <tr>
          <td width="100%" align="center" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica"><font size="2" face="Arial">
						<a href="http://www.wisc.edu" style="font-family: Arial">Home</a> | <a href="http://www.uwbadgers.com/">Sports</a>
			      <br>
						<a href="http://www.cs.wisc.edu">CS Home</a>  | <a href="http://www.wisc.edu/union/">Union</a><br>
						<a href="http://www.badgerherald.com">BH</a> | <a href="http://www.cardinal.wisc.edu">Cardinal</a> | 
						<a href="http://uwalumni.com/email">Alum Email</a></font>
						</font>
					<!--mstheme--></font></td>
        </tr>
      </table><!--mstheme--><font face="Arial, Helvetica">
      ...
      <!--mstheme--></font><table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td bgcolor="black" width="100%" align="center" height="20" background="wash2020.gif"><!--mstheme--><font face="Arial, Helvetica"><font face="Arial" size="2" color="#FFFFFF">Neil's Links</font></font>
          <!--mstheme--></font></td>
        </tr>
        <tr>
          <td width="100%" align="center" bgcolor="#000000"><!--mstheme--><font face="Arial, Helvetica">
				<font face="Arial, Helvetica" size="2">
					<a href="http://sharkeyextreme.com">Sharky Extreme</a> | <a href="http://www.zdnet.com/gamespot/filters/">GameSpot</a><br>
					<a href="http://space.com">space.com</a>
						| <a href="http://www.nature.com/nature/">nature.com</a> | <a href="http://popsci.com">popsci.com</a><br>
					<a href="http://labmice.net">Lab Mice</a> | <a href="http://www.zdnet.com">ZDNet</a>
				</font>
			<!--mstheme--></font></td>
        </tr>
      </table><!--mstheme--><font face="Arial, Helvetica">
...
<p>&nbsp;</p>
&nbsp;&nbsp;</font><!--mstheme--></font><!--msnavigation--></td></tr><!--msnavigation--></table><!--msnavigation--><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td><!--mstheme--><font face="Arial, Helvetica">
