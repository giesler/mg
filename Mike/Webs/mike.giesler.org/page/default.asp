...
<!--mstheme--></font><table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td bgcolor="#C00000" background="../_borders/bl-red_fade_top.jpg" width="400" height="30"><!--mstheme--><font face="Arial, Helvetica"><font size="6"><strong><img src="_derived/default.asp_cmp_mikes-website010_bnr.gif" width="400" height="30" border="0" alt="Page Mike"></strong></font><!--mstheme--></font></td>
...
<!--mstheme--></font><table border="1" cellpadding="8" cellspacing="0" align="center" bgcolor="black" bordercolordark="#FFFFFF" bordercolorlight="#FFFFFF">
	<tr>
		<td><!--mstheme--><font face="Arial, Helvetica">Sorry, but I no longer have a pager.  Please <a href="../email/">email</a> me instead.<!--mstheme--></font></td>
	</tr>
</table><!--mstheme--><font face="Arial, Helvetica">
