<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AutoTimer.ascx.cs" Inherits="pics.Controls.AutoTimer" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
