...
<%@ Page language="c#" Codebehind="Impersonate.aspx.cs" AutoEventWireup="false" Inherits="pics.Impersonate" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="left" border="0">
				...
				<tr>
					<td class="msn2contentwindow" vAlign="top">
						...
						<br>
						<br>
						<asp:Button ID="search" Runat="server" Text="OK" CssClass="btn"></asp:Button>
					</td>
				</tr>
			</table>
		</form>
