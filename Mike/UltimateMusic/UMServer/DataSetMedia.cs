...
namespace UMServer {
    ...
    public class DataSetMedia : DataSet {
        ...
        public class MediaDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public MediaRow AddMediaRow(string MediaFile, string Name, string Artist, System.Decimal Duration, int PlayCount, string Album, int Track, string Genre, int Bitrate, string Comments, System.DateTime DateAdded, System.DateTime DateUpdated) {
