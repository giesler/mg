...
namespace msn2.net
{
	...
	public class Config
    {
		...
		public void Login(string storageUrl)
		{
			...
			// load each tree
			//data = new ConfigData((configId, signinId, machineId, policyId, storageUrl);
	...
	public class ConfigDataAddEventArgs: EventArgs
	{
		...
		public ConfigDataAddEventArgs(System.Windows.Forms.IWin32Window owner, ConfigData parent)
		{
			this.owner		= owner;
			this.parent		= parent;
		}
