<%@ Page Language="C#" AutoEventWireup="true" CodeFile="defaultold.aspx.cs" Inherits="control" EnableViewState="false" EnableSessionState="False" %>
...
<body style="background-color: black;" onload="toggleGroup('<%=GetActiveGroup() %>')">
    <form id="form1" runat="server" style="height: 100%">
        ...
        <div id="switches" style="padding-left: 8px; position: fixed; width: 100%;">
        ...
        <div id="commands" style="padding-left: 8px; position: fixed; width: 100%;">
