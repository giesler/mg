...
namespace msn2.net.Configuration {
    ...
    public class DataSetCategory : DataSet {
        ...
        public class FavoritesCategoryDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private DataColumn columnConfigTreeType;
            ...
            internal DataColumn ConfigTreeTypeColumn {
                get {
                    return this.columnConfigTreeType;
                }
            }
            ...
            public FavoritesCategoryRow AddFavoritesCategoryRow(System.Guid CategoryId, string CategoryName, System.Guid ParentId, System.Guid UserId, string ItemType, string ItemUrl, string ItemData, string ConfigTreeType) {
            ...
            internal void InitVars() {
                ...
                this.columnConfigTreeType = this.Columns["ConfigTreeType"];
            }
            ...
            private void InitClass() {
                ...
                this.columnConfigTreeType = new DataColumn("ConfigTreeType", typeof(string), null, System.Data.MappingType.Element);
                this.Columns.Add(this.columnConfigTreeType);
        ...
        public class FavoritesCategoryRow : DataRow {
            ...
            public string ItemData {
                get {
                    try {
                        return ((string)(this[this.tableFavoritesCategory.ItemDataColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableFavoritesCategory.ItemDataColumn] = value;
                }
            }
            
            public string ConfigTreeType {
                get {
                    try {
                        return ((string)(this[this.tableFavoritesCategory.ConfigTreeTypeColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("Cannot get value because it is DBNull.", e);
                    }
                ...
                set {
                    this[this.tableFavoritesCategory.ConfigTreeTypeColumn] = value;
                }
            }
            ...
            public bool IsItemDataNull() {
                return this.IsNull(this.tableFavoritesCategory.ItemDataColumn);
            }
            
            public void SetItemDataNull() {
                this[this.tableFavoritesCategory.ItemDataColumn] = System.Convert.DBNull;
            }
            
            public bool IsConfigTreeTypeNull() {
                return this.IsNull(this.tableFavoritesCategory.ConfigTreeTypeColumn);
            }
            
            public void SetConfigTreeTypeNull() {
                this[this.tableFavoritesCategory.ConfigTreeTypeColumn] = System.Convert.DBNull;
            }
        }
