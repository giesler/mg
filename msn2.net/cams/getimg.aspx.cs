...
public partial class getimg : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (cam == "1")
        {
            address = "http://cam1.sp.msn2.net:8808/image/cc1";
        }
        else if (cam == "2")
        {
            address = "http://cam2.sp.msn2.net:8808/image/cc2";
        }
        else if (cam == "3")
        {
            rotate = false;
            address = "http://cam3.sp.msn2.net:8808/image/cc3";
        }
        else if (cam == "dw1")
        {
            rotate = false;
            address = "http://cam4.sp.msn2.net:8808/image/dw1";
        }
        else if (cam.ToLower() == "front")
        {
            rotate = false;
            address = "http://cam5.sp.msn2.net:8808/image/Front";
        }
        else if (cam.ToLower() == "side")
        {
            rotate = false;
            address = "http://cam1.sp.msn2.net:8808/image/Side";
        }
