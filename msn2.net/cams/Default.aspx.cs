...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.main.ImageUrl = string.Format("http://cam1.msn2.net:8081/getimg.aspx?c={0}&id={1}", this.cam, Guid.NewGuid());

        if (cam == "1")
        {
            this.main2.ImageUrl = string.Format("http://cam2.msn2.net:8081/getimg.aspx?c=2&id={0}", Guid.NewGuid());
