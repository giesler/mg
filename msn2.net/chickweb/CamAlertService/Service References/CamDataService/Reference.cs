...
namespace CamDataService.CamData
{
    ...
    public partial class PreviousAndNextLogItems : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CamDataService.CamData.LogItem NextItemField;

        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CamDataService.CamData.LogItem PreviousItemField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CamDataService.CamData.LogItem NextItem
        {
            get
            {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CamDataService.CamData.LogItem PreviousItem
        {
            get
            {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name = "Alert", Namespace = "http://schemas.datacontract.org/2004/07/CamLib")]
    [System.SerializableAttribute()]
    ...
    public interface ICameraData
    {
        ...
        CamDataService.CamData.LogItem[] GetItems(System.DateTime date);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICameraData/GetItems", ReplyAction = "http://tempuri.org/ICameraData/GetItemsResponse")]
        System.Threading.Tasks.Task<CamDataService.CamData.LogItem[]> GetItemsAsync(System.DateTime date);
        ...
        CamDataService.CamData.PreviousAndNextLogItems GetPreviousAndNextLogItems(string id);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICameraData/GetPreviousAndNextLogItems", ReplyAction = "http://tempuri.org/ICameraData/GetPreviousAndNextLogItemsResponse")]
        System.Threading.Tasks.Task<CamDataService.CamData.PreviousAndNextLogItems> GetPreviousAndNextLogItemsAsync(string id);
        ...
        CamDataService.CamData.VideoItem[] GetVideos(System.DateTime startTime, System.DateTime endTime);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICameraData/GetVideos", ReplyAction = "http://tempuri.org/ICameraData/GetVideosResponse")]
        System.Threading.Tasks.Task<CamDataService.CamData.VideoItem[]> GetVideosAsync(System.DateTime startTime, System.DateTime endTime);
        ...
        CamDataService.CamData.Alert[] GetAlertsBeforeDate(System.DateTime timestamp);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/ICameraData/GetAlertsBeforeDate", ReplyAction = "http://tempuri.org/ICameraData/GetAlertsBeforeDateResponse")]
        System.Threading.Tasks.Task<CamDataService.CamData.Alert[]> GetAlertsBeforeDateAsync(System.DateTime timestamp);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICameraDataChannel : CamDataService.CamData.ICameraData, System.ServiceModel.IClientChannel
    {
    }

    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CameraDataClient : System.ServiceModel.ClientBase<CamDataService.CamData.ICameraData>, CamDataService.CamData.ICameraData
    {
        ...
        public CamDataService.CamData.LogItem[] GetItems(System.DateTime date)
        {
            return base.Channel.GetItems(date);
        }

        public System.Threading.Tasks.Task<CamDataService.CamData.LogItem[]> GetItemsAsync(System.DateTime date)
        {
            return base.Channel.GetItemsAsync(date);
        }

        public CamDataService.CamData.PreviousAndNextLogItems GetPreviousAndNextLogItems(string id)
        {
            return base.Channel.GetPreviousAndNextLogItems(id);
        }

        public System.Threading.Tasks.Task<CamDataService.CamData.PreviousAndNextLogItems> GetPreviousAndNextLogItemsAsync(string id)
        {
            return base.Channel.GetPreviousAndNextLogItemsAsync(id);
        }

        public CamDataService.CamData.VideoItem[] GetVideos(System.DateTime startTime, System.DateTime endTime)
        {
            return base.Channel.GetVideos(startTime, endTime);
        }

        public System.Threading.Tasks.Task<CamDataService.CamData.VideoItem[]> GetVideosAsync(System.DateTime startTime, System.DateTime endTime)
        {
        ...
        public CamDataService.CamData.Alert[] GetAlertsBeforeDate(System.DateTime timestamp)
        {
            return base.Channel.GetAlertsBeforeDate(timestamp);
        }

        public System.Threading.Tasks.Task<CamDataService.CamData.Alert[]> GetAlertsBeforeDateAsync(System.DateTime timestamp)
        {
