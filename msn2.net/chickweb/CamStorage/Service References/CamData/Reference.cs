...
namespace CamStorage.CamData {
    ...
    public partial class PreviousAndNextLogItems : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CamStorage.CamData.LogItem NextItemField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private CamStorage.CamData.LogItem PreviousItemField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CamStorage.CamData.LogItem NextItem {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public CamStorage.CamData.LogItem PreviousItem {
            get {
    ...
    public interface ICameraData {
        ...
        CamStorage.CamData.LogItem[] GetItems(System.DateTime date);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICameraData/GetItems", ReplyAction="http://tempuri.org/ICameraData/GetItemsResponse")]
        System.Threading.Tasks.Task<CamStorage.CamData.LogItem[]> GetItemsAsync(System.DateTime date);
        ...
        CamStorage.CamData.PreviousAndNextLogItems GetPreviousAndNextLogItems(string id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICameraData/GetPreviousAndNextLogItems", ReplyAction="http://tempuri.org/ICameraData/GetPreviousAndNextLogItemsResponse")]
        System.Threading.Tasks.Task<CamStorage.CamData.PreviousAndNextLogItems> GetPreviousAndNextLogItemsAsync(string id);
        ...
        CamStorage.CamData.VideoItem[] GetVideos(System.DateTime startTime, System.DateTime endTime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICameraData/GetVideos", ReplyAction="http://tempuri.org/ICameraData/GetVideosResponse")]
        System.Threading.Tasks.Task<CamStorage.CamData.VideoItem[]> GetVideosAsync(System.DateTime startTime, System.DateTime endTime);
        ...
        CamStorage.CamData.LogItem[] GetAlertsBeforeDate(System.DateTime timestamp);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICameraData/GetAlertsBeforeDate", ReplyAction="http://tempuri.org/ICameraData/GetAlertsBeforeDateResponse")]
        System.Threading.Tasks.Task<CamStorage.CamData.LogItem[]> GetAlertsBeforeDateAsync(System.DateTime timestamp);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICameraDataChannel : CamStorage.CamData.ICameraData, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CameraDataClient : System.ServiceModel.ClientBase<CamStorage.CamData.ICameraData>, CamStorage.CamData.ICameraData {
        ...
        public CamStorage.CamData.LogItem[] GetItems(System.DateTime date) {
            return base.Channel.GetItems(date);
        }
        
        public System.Threading.Tasks.Task<CamStorage.CamData.LogItem[]> GetItemsAsync(System.DateTime date) {
            return base.Channel.GetItemsAsync(date);
        }
        
        public CamStorage.CamData.PreviousAndNextLogItems GetPreviousAndNextLogItems(string id) {
            return base.Channel.GetPreviousAndNextLogItems(id);
        }
        
        public System.Threading.Tasks.Task<CamStorage.CamData.PreviousAndNextLogItems> GetPreviousAndNextLogItemsAsync(string id) {
        ...
        public CamStorage.CamData.VideoItem[] GetVideos(System.DateTime startTime, System.DateTime endTime) {
            return base.Channel.GetVideos(startTime, endTime);
        }
        
        public System.Threading.Tasks.Task<CamStorage.CamData.VideoItem[]> GetVideosAsync(System.DateTime startTime, System.DateTime endTime) {
        ...
        public CamStorage.CamData.LogItem[] GetAlertsBeforeDate(System.DateTime timestamp) {
            return base.Channel.GetAlertsBeforeDate(timestamp);
        }
        
        public System.Threading.Tasks.Task<CamStorage.CamData.LogItem[]> GetAlertsBeforeDateAsync(System.DateTime timestamp) {
