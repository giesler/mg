namespace System.Linq
{
    ...
    internal static class LinqStrings
    {
        ...
        {
            return SR.GetString("Argument_InvalidId", new object[] { p0 });
        }

        internal static string Argument_InvalidSerializedString(object p0)
        {
            return SR.GetString("Argument_InvalidSerializedString", new object[] { p0 });
        }

        internal static string ArgumentArrayHasTooManyElements(object p0)
        {
            return SR.GetString("ArgumentArrayHasTooManyElements", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("InvalidTimeZone_InvalidRegistryData", new object[] { p0 });
        }
        ...
        {
            return SR.GetString("Security_CannotReadRegistryData", new object[] { p0 });
        }

        internal static string Serialization_CorruptField(object p0)
        {
            return SR.GetString("Serialization_CorruptField", new object[] { p0 });
        }

        internal static string Serialization_InvalidEscapeSequence(object p0)
        {
            return SR.GetString("Serialization_InvalidEscapeSequence", new object[] { p0 });
        }

        internal static string TimeZoneNotFound_MissingRegistryData(object p0)
        {
            return SR.GetString("TimeZoneNotFound_MissingRegistryData", new object[] { p0 });
        }
