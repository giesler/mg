namespace System.Linq
{
    ...
    public static class Queryable
    {
        ...
        public static IQueryable AsQueryable(this IEnumerable source)
        {
            ...
            if (type == null)
            {
                throw LinqError.ArgumentNotIEnumerableGeneric("source");
            }
        ...
        public static double Average(this IQueryable<double> source)
        {
            ...
            return source.Provider.Execute<double>(Expression.Call(null, (MethodInfo) MethodBase.GetCurrentMethod(), new Expression[] { source.Expression }));
        }
        ...
        public static decimal? Average(this IQueryable<decimal?> source)
        {
            ...
            return source.Provider.Execute<decimal?>(Expression.Call(null, (MethodInfo) MethodBase.GetCurrentMethod(), new Expression[] { source.Expression }));
        }
        ...
        public static float? Average(this IQueryable<float?> source)
        {
            ...
            return source.Provider.Execute<float?>(Expression.Call(null, (MethodInfo) MethodBase.GetCurrentMethod(), new Expression[] { source.Expression }));
        }
        ...
        public static IQueryable<TResult> Cast<TResult>(this IQueryable source)
        {
            ...
            return source.Provider.CreateQuery<TResult>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TResult) }), new Expression[] { source.Expression }));
        }
        ...
        public static bool Contains<TSource>(this IQueryable<TSource> source, TSource item)
        {
            ...
            return source.Provider.Execute<bool>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TSource) }), new Expression[] { source.Expression, Expression.Constant(item, typeof(TSource)) }));
        }
        ...
        public static bool Contains<TSource>(this IQueryable<TSource> source, TSource item, IEqualityComparer<TSource> comparer)
        {
            ...
            return source.Provider.Execute<bool>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TSource) }), new Expression[] { source.Expression, Expression.Constant(item, typeof(TSource)), Expression.Constant(comparer, typeof(IEqualityComparer<TSource>)) }));
        }
        ...
        public static IQueryable<TSource> DefaultIfEmpty<TSource>(this IQueryable<TSource> source, TSource defaultValue)
        {
            ...
            return source.Provider.CreateQuery<TSource>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TSource) }), new Expression[] { source.Expression, Expression.Constant(defaultValue, typeof(TSource)) }));
        }
        ...
        public static IQueryable<TSource> Distinct<TSource>(this IQueryable<TSource> source, IEqualityComparer<TSource> comparer)
        {
            ...
            return source.Provider.CreateQuery<TSource>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TSource) }), new Expression[] { source.Expression, Expression.Constant(comparer, typeof(IEqualityComparer<TSource>)) }));
        }
        ...
        public static long LongCount<TSource>(this IQueryable<TSource> source)
        {
            ...
            return source.Provider.Execute<long>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TSource) }), new Expression[] { source.Expression }));
        }
        ...
        public static int Sum(this IQueryable<int> source)
        {
            ...
            return source.Provider.Execute<int>(Expression.Call(null, (MethodInfo) MethodBase.GetCurrentMethod(), new Expression[] { source.Expression }));
        }
        ...
        public static long Sum(this IQueryable<long> source)
        {
            ...
            return source.Provider.Execute<long>(Expression.Call(null, (MethodInfo) MethodBase.GetCurrentMethod(), new Expression[] { source.Expression }));
        }
        ...
        public static IQueryable<TResult> Zip<TFirst, TSecond, TResult>(this IQueryable<TFirst> source1, IEnumerable<TSecond> source2, Expression<Func<TFirst, TSecond, TResult>> resultSelector)
        {
            ...
            return source1.Provider.CreateQuery<TResult>(Expression.Call(null, ((MethodInfo) MethodBase.GetCurrentMethod()).MakeGenericMethod(new Type[] { typeof(TFirst), typeof(TSecond), typeof(TResult) }), new Expression[] { source1.Expression, GetSourceExpression<TSecond>(source2), Expression.Quote(resultSelector) }));
        }
    }
}
