...
// 
namespace msn2.net.Controls.pics {
    ...
    public class RandomPictureService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public RandomPictureService() {
            this.Url = "http://pics/RandomPictureService.asmx";
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/RandomImageData", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public DataSetPicture RandomImageData(int personId) {
            object[] results = this.Invoke("RandomImageData", new object[] {
                        personId});
            return ((DataSetPicture)(results[0]));
        }
        
        /// <remarks/>
        public System.IAsyncResult BeginRandomImageData(int personId, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("RandomImageData", new object[] {
                        personId}, callback, asyncState);
        }
        
        /// <remarks/>
        public DataSetPicture EndRandomImageData(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((DataSetPicture)(results[0]));
        }
    }
