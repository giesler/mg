...
namespace Gsiot.Server
{
    ...
    public class RequestRouting : IEnumerable
    {
        ...
        class RoutingEnumerator : IEnumerator
        {
            Element first;
            Element current;

            internal RoutingEnumerator(Element first)
            {
                this.first = first;
            }
        ...
        {
            return new RoutingEnumerator(first);
        }
        ...
        public void Run()
        {
            ...
            while (true)
            {
                ...
                do
                {
                    try
                    {
                        ConsumeRequest(connection, serviceRoot, RequestRouting, out connectionClose);
                    }
                    catch
                    {
