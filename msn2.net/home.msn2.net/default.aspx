...
<body class="bodyStyle" style="color: black">
	...
	<div style="width: 100%; clear: both; background-color: black">
        <a class="smallthumb" href="http://cams.msn2.net/?c=dw1" target="_top"><img class="smallthumb" src="http://cam4.msn2.net:8808/getimg.aspx?c=dw1&amp;h=64&amp;id=th" style="height:64px;" /></a>
            
        <a class="smallthumb" href="http://cams.msn2.net/?c=front" target="_top"><img class="smallthumb" src="http://cam5.msn2.net:8808/getimg.aspx?c=front&amp;h=64&amp;id=th" style="height:64px;" /></a>
            
        <a class="smallthumb" href="http://cams.msn2.net/?c=side" target="_top"><img class="smallthumb" src="http://cam6.msn2.net:8808/getimg.aspx?c=side&amp;h=64&amp;id=th" style="height:64px;" /></a>
            
        <a class="smallthumb" href="http://cams.msn2.net/?c=gdoor" target="_top"><img class="smallthumb" src="http://cam1.msn2.net:8808/getimg.aspx?c=gdoor&amp;h=64&amp;id=th" style="height:64px;" /></a>
            
        <a class="smallthumb" href="http://cams.msn2.net/?c=CoopTop" target="_top"><img class="smallthumb" src="http://cam2.msn2.net:8808/getimg.aspx?c=CoopTop&amp;h=64&amp;id=th" style="height:64px;" /></a>
            
        <a class="smallthumb" href="http://cams.msn2.net/?c=CoopDoor" target="_top"><img class="smallthumb" src="http://cam3.msn2.net:8808/getimg.aspx?c=CoopDoor&amp;h=64&amp;id=th" style="height:64px;" /></a>	</div>
	<div style="float: left">
		<div style="float: left">
			<table style="width: 370px">
				<tr>
					<td style="width: 200px; align-content: center">outside
					</td>
					<td style="width: 150px; align-content: center">media room
					</td>
					<td style="width: 150px; align-content: center">bedroom
					</td>
				</tr>
				<tr>
					<td style="align-content: center; width: 170px">
						...
						<table>
							...
							<tr>
								<td style="width: 100px">
									...
									<asp:Label runat="server" ID="day0hi" />
									/
									<asp:Label runat="server" ID="day0low" />
									<br />
								...
								<td style="width: 100px">
									...
									<asp:Label runat="server" ID="day1hi" />
									/
									<asp:Label runat="server" ID="day1low" />
									<br />
									<div style="font-size: x-small">
								...
								<td style="width: 100px">
									...
									<asp:Label runat="server" ID="day2hi" />
									/
									<asp:Label runat="server" ID="day2low" />
									<br />
									<div style="font-size: x-small">
						...
						<table>
							<tr>
								<td colspan="2" style="border-bottom: 1px solid black">
									<asp:Label runat="server" ID="randleHeader" /></td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td style="width: 100px">
									...
									<asp:Label runat="server" ID="randleDay0Hi" />
									/
									<asp:Label runat="server" ID="randleDay0Low" />
									<br />
									<div style="font-size: x-small">
								...
								<td style="width: 100px">
									...
									<asp:Label runat="server" ID="randleDay1Hi" />
									/
									<asp:Label runat="server" ID="randleDay1Low" />
									<br />
									<div style="font-size: x-small">
