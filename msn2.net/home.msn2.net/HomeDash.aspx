                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size: x-small">
                                        <asp:Label runat="server" ID="day0pop" />&nbsp;/&nbsp;<asp:Label runat="server" ID="day0precip" /></div>
                                </td>
                                <td>
                                    ...
                                    <br />
                                    <div style="font-size: x-small">
                                        <asp:Label runat="server" ID="day1pop" />&nbsp;/&nbsp;<asp:Label runat="server" ID="day1precip" /></div>
                                </td>
                                <td>
                                    ...
                                    <br />
                                    <div style="font-size: x-small">
                                        <asp:Label runat="server" ID="day2pop" />&nbsp;/&nbsp;<asp:Label runat="server" ID="day2precip" /></div>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    <div style="font-size: x-small">
                                        <asp:Label runat="server" ID="randleDay0pop" />&nbsp;/&nbsp;<asp:Label runat="server" ID="randleDay0precip" /></div>
                                </td>
                                <td>
                                    ...
                                    <br />
                                    <div style="font-size: x-small">
                                        <asp:Label runat="server" ID="randleDay1pop" />&nbsp;/&nbsp;<asp:Label runat="server" ID="randleDay1precip" /></div>
                                </td>
                            </tr>
                        </table>
                    </td>
