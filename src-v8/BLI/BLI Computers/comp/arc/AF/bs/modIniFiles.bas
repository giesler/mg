...
'I'd like to know that too.  Unfortunately, due to the high interest in this
'product, no messages from the Internet will be answered if posted to my
'CompuServe address (it simply costs too much!).  Please correspond *only*
'via CompuServe!  Thanks.
'***************************************************************************
...
'***************************************************************************
'This THIRD RELEASE fixes a problem with the SysDevLoaded and SysDevRemove
...
'  Declare Function kpGetProfileInt Lib "kernel32" Alias "GetProfileInt" (ByVal lpAppName As String, ByVal lpKeyName As String, ByVal nDefault As Long) As Long
'  Declare Function kpGetProfileString Lib "kernel32" Alias "GetProfileString" (ByVal lpAppName As String, ByVal lpKeyName As Any, ByVal lpDefault As String, ByVal lpReturnedString As String, ByVal nSize As Long) As Long
'  Declare Function kpWriteProfileString Lib "kernel32" Alias "WriteProfileString" (ByVal lpAppName As Any, ByVal lpKeyName As Any, ByVal lpString As Any) As Long
'  Declare Function kpGetPrivateProfileInt Lib "kernel32" Alias "GetPrivateProfileInt" (ByVal lpAppName As String, ByVal lpKeyName As String, ByVal nDefault As Long, ByVal lpFileName As String) As Long
'  Declare Function kpGetPrivateProfileString Lib "kernel32" Alias "GetPrivateProfileString" (ByVal lpAppName As String, ByVal lpKeyName As Any, ByVal lpDefault As String, ByVal lpReturnedString As String, ByVal nSize As Long, ByVal lpFileName As String) As Long
'  Declare Function kpWritePrivateProfileString Lib "kernel32" Alias "WritePrivateProfileString" (ByVal lpAppName As Any, ByVal lpKeyName As Any, ByVal lpString As Any, ByVal lpFileName As String) As Long
'  Declare Function kpGetWindowsDirectory Lib "kernel32" Alias "GetWindowsDirectory" (ByVal lpBuffer As String, ByVal nSize As Long) As Long
  
  Declare Function kpSendMessage Lib "user32" Alias "SendMessageA" (ByVal hwnd As Long, ByVal wMsg As Long, ByVal wParam As Long, lParam As Any) As Long
  Declare Function kpGetProfileInt Lib "kernel32" Alias "GetProfileIntA" (ByVal lpAppName As String, ByVal lpKeyName As String, ByVal nDefault As Long) As Long
  Declare Function kpGetProfileString Lib "kernel32" Alias "GetProfileStringA" (ByVal lpAppName As String, ByVal lpKeyName As String, ByVal lpDefault As String, ByVal lpReturnedString As String, ByVal nSize As Long) As Long
  Declare Function kpGetPrivateProfileInt Lib "kernel32" Alias "GetPrivateProfileIntA" (ByVal lpApplicationName As String, ByVal lpKeyName As String, ByVal nDefault As Long, ByVal lpFileName As String) As Long
  Declare Function kpGetPrivateProfileString Lib "kernel32" Alias "GetPrivateProfileStringA" (ByVal lpApplicationName As String, ByVal lpKeyName As Any, ByVal lpDefault As String, ByVal lpReturnedString As String, ByVal nSize As Long, ByVal lpFileName As String) As Long
  Declare Function kpWriteProfileString Lib "kernel32" Alias "WriteProfileStringA" (ByVal lpszSection As String, ByVal lpszKeyName As String, ByVal lpszString As String) As Long
  Declare Function kpWritePrivateProfileString Lib "kernel32" Alias "WritePrivateProfileStringA" (ByVal lpApplicationName As String, ByVal lpKeyName As Any, ByVal lpString As Any, ByVal lpFileName As String) As Long
  Declare Function kpGetWindowsDirectory Lib "kernel32" Alias "GetWindowsDirectoryA" (ByVal lpBuffer As String, ByVal nSize As Long) As Long
...
Function SysDevLoaded(sDevChk As String) As Integer
...
Function SysDevRemove(sOldDev$, sBAK$) As Integer
...
Private Sub WinIniNotReg()
  ...
  'Warn *PROGRAMMER* that there's a logic error!
    MsgBox "WinIniNotReg", "[Section] Not Registered in Win.Ini!", 16, "IniFile Logic Error"
...
Public Function INISaveSetting(appName As String, strSection As String, strKey As String, strSetting As String)

PrivIniRegister strSection, App.Path & "\" & appName & ".ini"
PrivPutString strKey, strSetting

End Function

Public Function INIGetSetting(appName As String, strSection As String, strKey As String, strDefault As String) As String

PrivIniRegister strSection, App.Path & "\" & appName & ".ini"
INIGetSetting = PrivGetString(strKey, strDefault)
